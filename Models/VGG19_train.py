...
model.classifier[6] = nn.Linear(4096, 2)  # Modify the final fully connected layer to output 2 classes
...
# Save model
save_path = '/home/ant-pc/papers/FG/FF++/Model/VGG19_model.pth'
...
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('Training Loss Curve (VGG-19)')
loss_path = '/home/ant-pc/papers/FG/FF++/training_loss_curve_vgg19.png'
