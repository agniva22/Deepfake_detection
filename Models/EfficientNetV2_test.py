...
test_transform = transforms.Compose([
    transforms.Resize((224, 224)),  # Matches EfficientNet input size
    transforms.ToTensor(),
...
# Paths
test_folder = '/home/ant-pc/papers/FG/Celeb-DF/test'
model_path = '/home/ant-pc/papers/FG/Real_fake/model/Single_train_test/real_vs_fake/EfficientNetV2_model.pth'  # Updated path if needed
results_file = '/home/ant-pc/papers/FG/Real_fake/Result_Celeb-DF/EfficientNetV2_test_results.txt'
...
# Load EfficientNetV2-M from torchvision and modify classifier
...
result_str = f"""
--- EfficientNetV2 Test Results ({timestamp}) ---
