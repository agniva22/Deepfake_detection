...
# Save model
save_path = './Celeb-DF/Models/ResNet101_model.pth'
...
plt.xlabel('Epochs')
plt.ylabel('Loss')
plt.title('Training Loss Curve (ResNet-101)')
loss_path = '.Celeb-DF/training_loss_curve_resnet101.png'
