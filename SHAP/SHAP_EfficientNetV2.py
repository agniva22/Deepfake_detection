...
logging.basicConfig(filename='shap_extraction_efficientnetv2m.log', level=logging.INFO, 
...
shap_output_dir = './FF++/test/SHAP/EfficientNetV2M/original_sequences_actors'
