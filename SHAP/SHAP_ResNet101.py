...
logging.basicConfig(filename='shap_extraction_resnet101.log', level=logging.INFO, 
...
shap_output_dir = './FF++/test/SHAP/ResNet101/original_sequences_actors'
...
for image_name in image_names:
    ...
    try:
        ...
        shap_values = explainer(selected_image, max_evals=1010, batch_size=101)
